...
import { ShieldCheck, FileText, ScrollText, Mail, Calendar, KeyRound, BellRing, BadgeCheck, Ban, Globe } from "lucide-react";
...
export async function generateMetadata({
    ...
    return {
        title: isTr ? "Beuti | Bros404" : "Beuti | Bros404",
        description: isTr
            ? "Beuti ürünü ve Bros404 operatör bilgisi hakkında genel bilgiler."
            : "Overview of Beuti and the Bros404 operator relationship.",
    };
}

export default async function BeutiPage({
    params: { lang },
}: {
    params: { lang: Locale };
}) {
